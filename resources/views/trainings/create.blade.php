...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold mb-6">Add Training</h1>
    <form action="{{ route('trainings.store') }}" method="POST" class="bg-white shadow-md rounded-lg p-6">
        @csrf
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <select name="department_id" id="department_id" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
